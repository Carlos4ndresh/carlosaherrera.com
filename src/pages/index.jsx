...
import avatar from '../images/monphoto.jpeg'
    ...
    <Parallax pages={5}>
      ...
      </Hero>
      {
        <Projects offset={1}>
          ...
          {/* Create a cycle that consumes GitHub API and shows all mon repositories */}
          <ProjectsWrapper>
            <ProjectCard
              title="Freiheit"
      ...
      <About offset={3}>
        <Title>About</Title>
        <AboutHero>
          <Avatar src={avatar} alt="An unsettling image of me" />
          <AboutSub>Nothing to see here yet</AboutSub>
        </AboutHero>
        <AboutDesc>Neither here..</AboutDesc>
      </About>
      <Contact offset={4}>
        <Inner>
